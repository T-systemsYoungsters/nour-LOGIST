...
class Data():
    def __init__(self):
        ...
        self.filename:str = 'mydatabase.json'
    ...
    def add_player(self, player_name:str ,highscore:int=0):
    ...
    def edit_highscore(self, player_name:str ,new_highscore:int):
    ...
    def get_score(self, player_name:str):
        for player in self.data['players']:
            if player['player_name'] == player_name:
